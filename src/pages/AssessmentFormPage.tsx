  ...
  return <div className="space-y-7">
    ...
    <form onSubmit={submit} className="space-y-6">
      ...
      {mode === 'portal' ? <section className="rounded-2xl border border-[#E8CE99] bg-[#FFF7E8] p-6 sm:p-8">
        ...
        <section><div className="mb-5 rounded-2xl bg-[#171717] p-6 text-white"><UserRound className="text-[#E49A02]"/><h2 className="mt-4 text-xl font-black">Responder con el paciente presente</h2><p className="mt-2 text-xs leading-5 text-white/65">Leé las instrucciones y registrá una sola respuesta por pregunta. El resultado se calcula al finalizar.</p></div><AssessmentQuestionnaire instrument={dhiArgentina} responses={responses} onChange={setResponses}/></section>
