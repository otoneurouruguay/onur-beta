import { CalendarDays, CalendarX2, ChevronLeft, ClipboardCheck, Copy, Eye, FileImage, FileText, Pencil, PlayCircle, Plus, Trash2 } from 'lucide-react'
