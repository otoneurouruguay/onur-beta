...
describe('configuración base del ejercicio',()=>{
  ...
  it('mantiene independiente la relación objeto-fondo en configuraciones antiguas',()=>{expect(normalizeExerciseConfig({backgroundType:'bars',backgroundSpeed:20}).targetBackgroundRelation).toBe('independent')})
})
